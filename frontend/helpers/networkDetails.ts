...
export const NETWORKS: { [key: number]: INetwork } = {
  [NetworkId.MAINNET]: {
    ...
    image: "/static/img/tokens/wETH.svg",
  ...
  [NetworkId.TESTNET_RINKEBY]: {
    ...
    rpcUrls: [""],
    blockExplorerUrls: [
      "https://eth-rinkeby.alchemyapi.io/v2/ctXuzDMK6VG6DB8QBtfczdwtm2FfgogA",
    ],
    image: "/static/img/tokens/wETH.svg",
    imageAltText: "Ethereum Logo",
  ...
  [NetworkId.AVALANCHE_TESTNET]: {
    ...
    image: "/static/img/tokens/AVAX.svg",
